    ...
    <div id="contenidoUltimosRecitales" class="contenidoHome">
     <c:forEach items="${miListaDeEvento}" var="evento">
         <div class="contenedorEventosDestacados">
             ...
             <a href="detalleEventos?idEvento=${evento.getidEvento()}"><img src="images/${evento.getImagenPrincipalEvento()}" style="height: 200px; width:300px;"></a>
             ...
             <a href="detalleEventos?idEvento=${evento.getidEvento()}">LEER MÁS...</a>
